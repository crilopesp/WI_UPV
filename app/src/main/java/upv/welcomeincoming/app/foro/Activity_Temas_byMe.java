...
public class Activity_Temas_byMe extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.temas_me_title));
    ...
    class cargarTemasTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            arrayTemas = control.getTemasMe(0, _context);
            return null;
        }
            ...
            progress.setOnKeyListener(new DialogInterface.OnKeyListener() {
                ...
                public boolean onKey(DialogInterface dialogInterface, int i, KeyEvent keyEvent) {
                    if (keyEvent.getKeyCode() == KeyEvent.KEYCODE_BACK) {
                        progress.dismiss();
                        Activity_Temas_byMe.this.onBackPressed();
                    }
                    return false;
                }
            });

...
import util.TransportsListAdapter;
 ...
 */
public class info_transportes_fragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getListView().setAdapter(new TransportsListAdapter(getActivity(), 0, listaTransportes));
    }

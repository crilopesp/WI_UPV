...
public class ListAdapter_Transportes extends ArrayAdapter<Transporte> {
    private Context _context;
    private List<Transporte> Transportes;

    public ListAdapter_Transportes(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
        _context = context;
    }

    public ListAdapter_Transportes(Context context, int resource, List<Transporte> items) {
